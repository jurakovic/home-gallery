...
- webapp: Hide the navigation of the media view after an idle time of every media, so that a swipe through the media keeps it out of the way. A tap or a click shows it until the next media is shown
